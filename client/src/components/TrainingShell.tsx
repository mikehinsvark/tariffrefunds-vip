...
export default function TrainingShell({ children, eyebrow = "INTERNAL AGENT TRAINING", showAlert = true, footerNote = "Internal agent training guidance only. Not legal, customs, tax, financial, or professional advice." }: { children: ReactNode; eyebrow?: string; showAlert?: boolean; footerNote?: string }) {
